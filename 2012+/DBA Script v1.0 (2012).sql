...
IF @VersionMajor IN ('8.00', '9.00', '10.00', '10.50') BEGIN

	PRINT 'We have detected you are on a version of MSSQL that is not support by this script. Script requires MSSQL 2012 or newer editions.'
