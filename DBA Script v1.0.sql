...
@infoSEC varchar(5), @infoFRAG varchar(5), @infoSTAT varchar(5), @Inventory varchar(5), @showTableSizes varchar(5), @Version as varchar (128)
...
SET @Version 	= left(@@Version, 35)  	-- Used later to exclude functionality not found in 2008
...
IF @WAITSTATS = 'TRUE' BEGIN
	...
	IF @Version like 'Microsoft SQL Server 201%' BEGIN 
